...
class RiskIntelligenceAgent:
    ...
    def generate_external_analysis(self, query: str, internal_context: str) -> str:
        ...
        primary_prompt = (
            ...
            f"{research_context}\n\n"
            "Please provide a comprehensive analysis with ALL of the following sections:\n\n"
            "## EXECUTIVE SUMMARY\n"
            "3–5 bullets summarizing the main risk picture.\n\n"
            "## KEY EXTERNAL RISKS\n"
            "For each key risk, explain:\n"
            ...
            "- Cite sources inline [1], [2], etc.\n\n"
            "## SIMILAR GLOBAL PROJECTS\n"
            "Include a table with 10-20 real {project_type} projects:\n"
            ...
            "- Table format: | Project | Country/Region | Risk Type | Impact | Mitigation | Year | Source |\n\n"
            "## RECOMMENDED ACTIONS\n"
            "Provide actionable recommendations for risk managers based on the analysis above.\n\n"
            "## FULL REFERENCE LIST\n"
            "Include 50-80 sources (70-80% from engineering academic sources: ASCE, ICE, ScienceDirect, Springer, ArXiv engineering, USACE, PIANC, ITA-AITES)\n"
            ...
            "- All sections must be included with proper citations."
        )
        ...
        if needs_retry:
            ...
            expanded_prompt = (
                ...
                "- Each project in the table MUST have: Risk type encountered, What happened (root cause), Impact (cost, schedule, safety, quality), Mitigation method, Source URL from an engineering-authoritative source\n"
